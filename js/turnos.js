...
░░░╚═╝░░░░╚═════╝░╚═╝░░╚═╝╚═╝░░╚══╝░╚════╝░  ╚══════╝
    ...
    if (turno == 1){
     ...
     if ( vidaplayer1 < 1){
          ...
          dadoroll = [
            'https://i.imgur.com/UtX7wJS.png', //0
            'https://i.imgur.com/UtX7wJS.png', //1
            'https://i.imgur.com/UtX7wJS.png', //2
            'https://i.imgur.com/UtX7wJS.png', //3
            'https://i.imgur.com/UtX7wJS.png', //4
            'https://i.imgur.com/UtX7wJS.png', //5
            'https://i.imgur.com/UtX7wJS.png', //6
            'https://i.imgur.com/UtX7wJS.png', //7
            'https://i.imgur.com/UtX7wJS.png', //8
            'https://i.imgur.com/UtX7wJS.png'];//9
...
if (furiabarbaro1 > 1){
  furiabarbaro1--;
  if (furiabarbaro1 == 3){
    player1.setAttribute('src', 'https://i.imgur.com/XZnJh43.png');
  };
  if (furiabarbaro1 == 2){
    player1.setAttribute('src', 'https://i.imgur.com/6olTQSo.png');
  };
};
if (furiabarbaro1 == 1){
  furiabarbaro1 = 0;
    ...
    if (turno == 2){
          ...
          if (vidaplayer2 < 1 && vidaplayer4 < 1 && vidaplayer6 <1 ){
            ...
            if (furiabarbaro2 > 1){
              furiabarbaro2--;
              if (furiabarbaro2 == 3){
                player2.setAttribute('src', 'https://i.imgur.com/XZnJh43.png');
              };
              if (furiabarbaro2 == 2){
                player2.setAttribute('src', 'https://i.imgur.com/6olTQSo.png');
              };
            };
            if (furiabarbaro2 == 1){
              furiabarbaro2 = 0;
    ...
    if (turno == 3){
      ...
      vidaplayer3show.innerHTML = vidaplayer3
            ...
            if (furiabarbaro3 > 1){
              furiabarbaro3--;
              if (furiabarbaro3 == 3){
                player3.setAttribute('src', 'https://i.imgur.com/XZnJh43.png');
              };
              if (furiabarbaro3 == 2){
                player3.setAttribute('src', 'https://i.imgur.com/6olTQSo.png');
              };
            };
            if (furiabarbaro3 == 1){
              furiabarbaro3 = 0;
    ...
    if (turno == 4){
      ...
      vidaplayer4show.innerHTML = vidaplayer4
            ...
            if (furiabarbaro4 > 1){
              furiabarbaro4--;
              if (furiabarbaro4 == 3){
                player4.setAttribute('src', 'https://i.imgur.com/XZnJh43.png');
              };
              if (furiabarbaro4 == 2){
                player4.setAttribute('src', 'https://i.imgur.com/6olTQSo.png');
              };
            };
            if (furiabarbaro4 == 1){
              furiabarbaro4 = 0;
    ...
    if (turno == 5){
      ...
      vidaplayer5show.innerHTML = vidaplayer5
            ...
            if (furiabarbaro5 > 1){
              furiabarbaro5--;
              if (furiabarbaro5 == 3){
                player5.setAttribute('src', 'https://i.imgur.com/XZnJh43.png');
              };
              if (furiabarbaro5 == 2){
                player5.setAttribute('src', 'https://i.imgur.com/6olTQSo.png');
              };
            };
            if (furiabarbaro5 == 1){
              furiabarbaro5 = 0;
    ...
    if (turno == 6){
          ...
          if ( vidaplayer6 < 1){
            ...
            if (furiabarbaro6 > 1){
              furiabarbaro6--;
              if (furiabarbaro6 == 3){
                player6.setAttribute('src', 'https://i.imgur.com/XZnJh43.png');
              };
              if (furiabarbaro6 == 2){
                player6.setAttribute('src', 'https://i.imgur.com/6olTQSo.png');
              };
            };
            if (furiabarbaro6 == 1){
              furiabarbaro6 = 0;
